...
import com.example.musicplayer.databinding.BottomSheetMoreBinding
...
class SongBottomSheet (private val context: Context) :
    BaseBottomSheetDialog<BottomSheetMoreBinding>(context) {

       private  var song: Audio = Audio.EMPTY_SONG

    fun setAudio(currentAudio: Audio) {
        song = currentAudio
        binding.apply {
    ...
    override fun getViewBinding(): BottomSheetMoreBinding {
        println("currentAudio: $song")
        return BottomSheetMoreBinding.inflate(layoutInflater)
    }
