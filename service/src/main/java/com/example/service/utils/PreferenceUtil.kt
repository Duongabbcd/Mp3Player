...
class PreferenceUtil(context: Context) {
    ...
    fun getSongPlaylistSortOrder(): String? {
        return mPreferences!!.getString(
            ALBUM_SORT_ORDER,
            ODER_SORT_TITLE_ASC
        )
    ...
    fun setSongPlaylistSortOrder(sortOrder: String?) {
        val editor = mPreferences!!.edit()
    ...
    fun getAllRecentlyPlayed(): List<Audio> {
        val result = mPreferences?.getString(RECENTLY_PLAYED_SONGS, "") ?: ""
    ...
    fun setAllRecentlyPlayed(audios: String) {
        val editor = mPreferences?.edit()
        editor?.putString(RECENTLY_PLAYED_SONGS, audios)
        editor?.apply()
    }

    // Retrieve the last activity's class name
//    fun getLastActivity() : Class<*>?{
//        val lastActivityClassName = mPreferences?.getString(LAST_ACTIVITY_NAME, "") ?: ""
//        // Retrieve the last activity's class name from SharedPreferences
//
//        return try {
//            Class.forName(lastActivityClassName)
//        } catch (e: Exception) {
//            e.printStackTrace()
//            null
//        }
...
//        val editor = mPreferences?.edit()
//        editor?.putString(LAST_ACTIVITY_NAME, activityName)
//        editor?.apply()
//    }
    ...
    companion object {
        ...
        const val LAST_ACTIVITY_NAME = "last_activity_name"
        ...
        const val RECENTLY_PLAYED_SONGS = "RECENTLY_PLAYED_SONGS"
